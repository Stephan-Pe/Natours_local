...
}; // type comes from API 'success' or 'error'
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibW9nbGk2MyIsImEiOiJja3QxbHJzeHMwYm1wMm9vOGV0cnZuczE4In0.I15j6E1VAsL-AeiikwjYQQ';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status = 'success') {
              (0, _alerts.showAlert)('success', 'Sign Up Successfully, please check your Email for verification!');
              window.setTimeout(function () {
                location.assign('/');
              }, 2000);
            }
...
var stripe = Stripe('pk_test_51JWe8yFCLANt3bYYVkecSY1MjqjZAZRQJWAFtnXsaqBrwu0ejBfqIKBZXZW6uuseHlcOFc649VRigyPgF2aFesCF00FRdnUxMC');
...
},{"core-js/stable":"../../node_modules/core-js/stable/index.js","regenerator-runtime/runtime":"../../node_modules/regenerator-runtime/runtime.js","./alerts":"alerts.js","./login":"login.js","./mapbox":"mapbox.js","./signup":"signup.js","./stripe":"stripe.js","./updateSettings":"updateSettings.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
